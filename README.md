...
```sh
git clone git@github.com:tomheinan/gilded-rose-swift.git
cd gilded-rose-swift
open GildedRose.xcodeproj/
```

The master branch contains the starting point for the exercise. Run the tests (and you can run them with the **&#x2318;U** shortcut by default).
